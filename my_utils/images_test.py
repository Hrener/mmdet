...
def s_result(img,
    ...
    class_name = tuple([str(i+1) for i in range(1)])
    img = mmcv.imread(img)
    img = img.copy()
    ...
    for ann in range(len(labels)):
        ...
        image_result = out_file.split('/')[-1]+','+str(bboxes[ann][0])+','+str(bboxes[ann][1])+','+str(bboxes[ann][2])+','+str(bboxes[ann][3])+','+'face'+','+str(bboxes[ann][4])+'\n'
...
# checkpoint_file = "/home1/rhhHD/rhh/mmdetection/work_dirs/cascade_rcnn_dconv_c3-c5_r50_fpn_1x_3_images/latest.pth"
...
# config_file = '/home1/rhhHD/rhh/mmdetection/configs/dcn/cascade_rcnn_dconv_c3-c5_r50_fpn_1x.py'
# checkpoint_file = "/home1/rhhHD/rhh/mmdetection/work_dirs/cartoon/crcnn_dconv_c3-c5_r50_fpn_1x_900_600_bs8-0.8869/latest.pth"

config_file = '/home1/rhhHD/rhh/mmdetection/configs/htc/htc_without_semantic_r50_fpn_1x.py'
checkpoint_file = "/home1/rhhHD/rhh/mmdetection/work_dirs/cartoon/htc_without_semantic_r50_fpn_1x/latest.pth"
...
# # 测试一系列图片
test_json = '/home1/rhhHD/rhh/Datasets/iCartonnFace/cartoon_coco/coco/annotations/cartoon_instances_test2017.json'
test_path = '/home1/rhhHD/rhh/Datasets/iCartonnFace/personai_icartoonface_detval/'
#result = inference_detector(model, img)
#print(result)
save_path = '/home1/rhhHD/rhh/mmdetection/my_utils/cartoon_results/results_htc_600_400/'
images = []
predict = []
...
# with open('/home1/rhhHD/rhh/mmdetection/my_utils/cartoon_results/results_1000_600_400/results_1000_600_400.json', 'w', encoding='utf-8') as fw:
    # json.dump(predict, fw, ensure_ascii=False, cls=MyEncoder)
with open('/home1/rhhHD/rhh/mmdetection/my_utils/cartoon_results/results_htc_600_400.csv', 'w', encoding='utf-8') as fw:
    for pred in predict:
        fw.write(pred)